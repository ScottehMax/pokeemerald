...
#define SCANLINE_EFFECT_REG_BG0HOFS (REG_OFFSET_BG0HOFS - REG_OFFSET_BG0HOFS)
#define SCANLINE_EFFECT_REG_BG0VOFS (REG_OFFSET_BG0VOFS - REG_OFFSET_BG0HOFS)
#define SCANLINE_EFFECT_REG_BG1HOFS (REG_OFFSET_BG1HOFS - REG_OFFSET_BG0HOFS)
#define SCANLINE_EFFECT_REG_BG1VOFS (REG_OFFSET_BG1VOFS - REG_OFFSET_BG0HOFS)
#define SCANLINE_EFFECT_REG_BG2HOFS (REG_OFFSET_BG2HOFS - REG_OFFSET_BG0HOFS)
#define SCANLINE_EFFECT_REG_BG2VOFS (REG_OFFSET_BG2VOFS - REG_OFFSET_BG0HOFS)
#define SCANLINE_EFFECT_REG_BG3HOFS (REG_OFFSET_BG3HOFS - REG_OFFSET_BG0HOFS)
#define SCANLINE_EFFECT_REG_BG3VOFS (REG_OFFSET_BG3VOFS - REG_OFFSET_BG0HOFS)
