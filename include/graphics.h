...
extern const u8 gBattleInterface_NewHpBarGfx[][32];
extern const u8 gBattleInterface_NewStatusGfx[][4][32];
extern const u16 *const gBattleInterface_NewStatusPal[];
extern const u8 gBattleInterface_NewStatusPalCount[];
