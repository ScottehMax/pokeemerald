...
PORTED_C_SRCS := src/math_util.c src/random.c src/heal_location.c src/blit.c src/dynamic_placeholder_text_util.c src/play_time.c src/save_location.c src/mystery_event_msg.c
