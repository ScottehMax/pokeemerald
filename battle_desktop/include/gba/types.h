...
/* GBA hardware structs needed by sprite.h etc */
struct BgCnt {
    u16 priority:2;
    u16 charBaseBlock:2;
...
struct ObjAffineSrcData { s16 xScale, yScale; u16 rotation; };
struct SioMultiCnt { u16 baudRate:2; u16 si:1; u16 sd:1; u16 id:2; u16 error:1; u16 enable:1; u16 unused_11_8:4; u16 mode:2; u16 intrEnable:1; u16 unused_15:1; u16 data; };
