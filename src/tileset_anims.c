...
static void InitPrimaryTilesetAnimationForLayout(const struct MapLayout *);
static void InitSecondaryTilesetAnimationForLayout(const struct MapLayout *);
static void AppendTilesetAnimTransfer(const u16 *, u16 *, u16);
static bool8 TryAppendBattleOwTilesetAnimToBuffer(const u16 *, u16 *, u16);
