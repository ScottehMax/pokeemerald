...
static const struct BattleOwBgLayoutOffset sBattleOwBgLayoutOffsets[] =
{
    ...
    {LAYOUT_FORTREE_CITY, 24, 10},
    {LAYOUT_LILYCOVE_CITY, 20, 5},
    {LAYOUT_MOSSDEEP_CITY, 14, 23},
    {LAYOUT_SOOTOPOLIS_CITY, 11, 38},
    {LAYOUT_EVER_GRANDE_CITY, 15, 13},

    {LAYOUT_LITTLEROOT_TOWN, 2, 6},
    {LAYOUT_OLDALE_TOWN, 3, 7},
    {LAYOUT_DEWFORD_TOWN, 1, 8},
    {LAYOUT_LAVARIDGE_TOWN, 5, 6},
    {LAYOUT_FALLARBOR_TOWN, 1, 6},
    {LAYOUT_VERDANTURF_TOWN, 2, 5},
    {LAYOUT_PACIFIDLOG_TOWN, 2, 13},
    ...
    {LAYOUT_SEAFLOOR_CAVERN_ROOM9, 6, 24}, // maybe want to change this later once we have offsets past the border
    ...
    {LAYOUT_METEOR_FALLS_STEVENS_CAVE, 10, 4},
...
void BattleOverworldScene_CreateTrainerSprites(void)
{
    ...
    {
        opponentGraphicsInfo = GetBattleOwTrainerGraphicsInfo(gTrainers[gTrainerBattleOpponent_A].trainerPic,
...
bool8 BattleOverworldScene_DrawBattlerOnBg(u8 battler, u8 bgId, u8 paletteId, u16 tilesOffset, u8 *tiles, u16 *tilemap, s16 *bgX, s16 *bgY, u16 *frameTileCount)
{
    ...
    *frameTileCount = tileSize / TILE_SIZE_4BPP;
    ...
    CpuCopy16(sprite->images[firstFrame].data, tiles + TILE_SIZE_4BPP, tileSize);
    CpuCopy16(sprite->images[secondFrame].data, tiles + TILE_SIZE_4BPP + tileSize, tileSize);
