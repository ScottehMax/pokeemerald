...
gBattleScriptsForMoveEffects::
	asset_ptr BattleScript_EffectHit                    @ EFFECT_HIT
	asset_ptr BattleScript_EffectSleep                  @ EFFECT_SLEEP
	asset_ptr BattleScript_EffectPoisonHit              @ EFFECT_POISON_HIT
	asset_ptr BattleScript_EffectAbsorb                 @ EFFECT_ABSORB
	asset_ptr BattleScript_EffectBurnHit                @ EFFECT_BURN_HIT
	asset_ptr BattleScript_EffectFreezeHit              @ EFFECT_FREEZE_HIT
	asset_ptr BattleScript_EffectParalyzeHit            @ EFFECT_PARALYZE_HIT
	asset_ptr BattleScript_EffectExplosion              @ EFFECT_EXPLOSION
	asset_ptr BattleScript_EffectDreamEater             @ EFFECT_DREAM_EATER
	asset_ptr BattleScript_EffectMirrorMove             @ EFFECT_MIRROR_MOVE
	asset_ptr BattleScript_EffectAttackUp               @ EFFECT_ATTACK_UP
	asset_ptr BattleScript_EffectDefenseUp              @ EFFECT_DEFENSE_UP
	asset_ptr BattleScript_EffectHit                    @ EFFECT_SPEED_UP
	asset_ptr BattleScript_EffectSpecialAttackUp        @ EFFECT_SPECIAL_ATTACK_UP
	asset_ptr BattleScript_EffectHit                    @ EFFECT_SPECIAL_DEFENSE_UP
	asset_ptr BattleScript_EffectHit                    @ EFFECT_ACCURACY_UP
	asset_ptr BattleScript_EffectEvasionUp              @ EFFECT_EVASION_UP
	asset_ptr BattleScript_EffectHit                    @ EFFECT_ALWAYS_HIT
	asset_ptr BattleScript_EffectAttackDown             @ EFFECT_ATTACK_DOWN
	asset_ptr BattleScript_EffectDefenseDown            @ EFFECT_DEFENSE_DOWN
	asset_ptr BattleScript_EffectSpeedDown              @ EFFECT_SPEED_DOWN
	asset_ptr BattleScript_EffectHit                    @ EFFECT_SPECIAL_ATTACK_DOWN
	asset_ptr BattleScript_EffectHit                    @ EFFECT_SPECIAL_DEFENSE_DOWN
	asset_ptr BattleScript_EffectAccuracyDown           @ EFFECT_ACCURACY_DOWN
	asset_ptr BattleScript_EffectEvasionDown            @ EFFECT_EVASION_DOWN
	asset_ptr BattleScript_EffectHaze                   @ EFFECT_HAZE
	asset_ptr BattleScript_EffectBide                   @ EFFECT_BIDE
	asset_ptr BattleScript_EffectRampage                @ EFFECT_RAMPAGE
	asset_ptr BattleScript_EffectRoar                   @ EFFECT_ROAR
	asset_ptr BattleScript_EffectMultiHit               @ EFFECT_MULTI_HIT
	asset_ptr BattleScript_EffectConversion             @ EFFECT_CONVERSION
	asset_ptr BattleScript_EffectFlinchHit              @ EFFECT_FLINCH_HIT
	asset_ptr BattleScript_EffectRestoreHp              @ EFFECT_RESTORE_HP
	asset_ptr BattleScript_EffectToxic                  @ EFFECT_TOXIC
	asset_ptr BattleScript_EffectPayDay                 @ EFFECT_PAY_DAY
	asset_ptr BattleScript_EffectLightScreen            @ EFFECT_LIGHT_SCREEN
	asset_ptr BattleScript_EffectTriAttack              @ EFFECT_TRI_ATTACK
	asset_ptr BattleScript_EffectRest                   @ EFFECT_REST
	asset_ptr BattleScript_EffectOHKO                   @ EFFECT_OHKO
	asset_ptr BattleScript_EffectRazorWind              @ EFFECT_RAZOR_WIND
	asset_ptr BattleScript_EffectSuperFang              @ EFFECT_SUPER_FANG
	asset_ptr BattleScript_EffectDragonRage             @ EFFECT_DRAGON_RAGE
	asset_ptr BattleScript_EffectTrap                   @ EFFECT_TRAP
	asset_ptr BattleScript_EffectHit                    @ EFFECT_HIGH_CRITICAL
	asset_ptr BattleScript_EffectDoubleHit              @ EFFECT_DOUBLE_HIT
	asset_ptr BattleScript_EffectRecoilIfMiss           @ EFFECT_RECOIL_IF_MISS
	asset_ptr BattleScript_EffectMist                   @ EFFECT_MIST
	asset_ptr BattleScript_EffectFocusEnergy            @ EFFECT_FOCUS_ENERGY
	asset_ptr BattleScript_EffectRecoil                 @ EFFECT_RECOIL
	asset_ptr BattleScript_EffectConfuse                @ EFFECT_CONFUSE
	asset_ptr BattleScript_EffectAttackUp2              @ EFFECT_ATTACK_UP_2
	asset_ptr BattleScript_EffectDefenseUp2             @ EFFECT_DEFENSE_UP_2
	asset_ptr BattleScript_EffectSpeedUp2               @ EFFECT_SPEED_UP_2
	asset_ptr BattleScript_EffectSpecialAttackUp2       @ EFFECT_SPECIAL_ATTACK_UP_2
	asset_ptr BattleScript_EffectSpecialDefenseUp2      @ EFFECT_SPECIAL_DEFENSE_UP_2
	asset_ptr BattleScript_EffectHit                    @ EFFECT_ACCURACY_UP_2
	asset_ptr BattleScript_EffectHit                    @ EFFECT_EVASION_UP_2
	asset_ptr BattleScript_EffectTransform              @ EFFECT_TRANSFORM
	asset_ptr BattleScript_EffectAttackDown2            @ EFFECT_ATTACK_DOWN_2
	asset_ptr BattleScript_EffectDefenseDown2           @ EFFECT_DEFENSE_DOWN_2
	asset_ptr BattleScript_EffectSpeedDown2             @ EFFECT_SPEED_DOWN_2
	asset_ptr BattleScript_EffectHit                    @ EFFECT_SPECIAL_ATTACK_DOWN_2
	asset_ptr BattleScript_EffectSpecialDefenseDown2    @ EFFECT_SPECIAL_DEFENSE_DOWN_2
	asset_ptr BattleScript_EffectHit                    @ EFFECT_ACCURACY_DOWN_2
	asset_ptr BattleScript_EffectHit                    @ EFFECT_EVASION_DOWN_2
	asset_ptr BattleScript_EffectReflect                @ EFFECT_REFLECT
	asset_ptr BattleScript_EffectPoison                 @ EFFECT_POISON
	asset_ptr BattleScript_EffectParalyze               @ EFFECT_PARALYZE
	asset_ptr BattleScript_EffectAttackDownHit          @ EFFECT_ATTACK_DOWN_HIT
	asset_ptr BattleScript_EffectDefenseDownHit         @ EFFECT_DEFENSE_DOWN_HIT
	asset_ptr BattleScript_EffectSpeedDownHit           @ EFFECT_SPEED_DOWN_HIT
	asset_ptr BattleScript_EffectSpecialAttackDownHit   @ EFFECT_SPECIAL_ATTACK_DOWN_HIT
	asset_ptr BattleScript_EffectSpecialDefenseDownHit  @ EFFECT_SPECIAL_DEFENSE_DOWN_HIT
	asset_ptr BattleScript_EffectAccuracyDownHit        @ EFFECT_ACCURACY_DOWN_HIT
	asset_ptr BattleScript_EffectHit                    @ EFFECT_EVASION_DOWN_HIT
	asset_ptr BattleScript_EffectSkyAttack              @ EFFECT_SKY_ATTACK
	asset_ptr BattleScript_EffectConfuseHit             @ EFFECT_CONFUSE_HIT
	asset_ptr BattleScript_EffectTwineedle              @ EFFECT_TWINEEDLE
	asset_ptr BattleScript_EffectHit                    @ EFFECT_VITAL_THROW
	asset_ptr BattleScript_EffectSubstitute             @ EFFECT_SUBSTITUTE
	asset_ptr BattleScript_EffectRecharge               @ EFFECT_RECHARGE
	asset_ptr BattleScript_EffectRage                   @ EFFECT_RAGE
	asset_ptr BattleScript_EffectMimic                  @ EFFECT_MIMIC
	asset_ptr BattleScript_EffectMetronome              @ EFFECT_METRONOME
	asset_ptr BattleScript_EffectLeechSeed              @ EFFECT_LEECH_SEED
	asset_ptr BattleScript_EffectSplash                 @ EFFECT_SPLASH
	asset_ptr BattleScript_EffectDisable                @ EFFECT_DISABLE
	asset_ptr BattleScript_EffectLevelDamage            @ EFFECT_LEVEL_DAMAGE
	asset_ptr BattleScript_EffectPsywave                @ EFFECT_PSYWAVE
	asset_ptr BattleScript_EffectCounter                @ EFFECT_COUNTER
	asset_ptr BattleScript_EffectEncore                 @ EFFECT_ENCORE
	asset_ptr BattleScript_EffectPainSplit              @ EFFECT_PAIN_SPLIT
	asset_ptr BattleScript_EffectSnore                  @ EFFECT_SNORE
	asset_ptr BattleScript_EffectConversion2            @ EFFECT_CONVERSION_2
	asset_ptr BattleScript_EffectLockOn                 @ EFFECT_LOCK_ON
	asset_ptr BattleScript_EffectSketch                 @ EFFECT_SKETCH
	asset_ptr BattleScript_EffectHit                    @ EFFECT_UNUSED_60
	asset_ptr BattleScript_EffectSleepTalk              @ EFFECT_SLEEP_TALK
	asset_ptr BattleScript_EffectDestinyBond            @ EFFECT_DESTINY_BOND
	asset_ptr BattleScript_EffectFlail                  @ EFFECT_FLAIL
	asset_ptr BattleScript_EffectSpite                  @ EFFECT_SPITE
	asset_ptr BattleScript_EffectHit                    @ EFFECT_FALSE_SWIPE
	asset_ptr BattleScript_EffectHealBell               @ EFFECT_HEAL_BELL
	asset_ptr BattleScript_EffectHit                    @ EFFECT_QUICK_ATTACK
	asset_ptr BattleScript_EffectTripleKick             @ EFFECT_TRIPLE_KICK
	asset_ptr BattleScript_EffectThief                  @ EFFECT_THIEF
	asset_ptr BattleScript_EffectMeanLook               @ EFFECT_MEAN_LOOK
	asset_ptr BattleScript_EffectNightmare              @ EFFECT_NIGHTMARE
	asset_ptr BattleScript_EffectMinimize               @ EFFECT_MINIMIZE
	asset_ptr BattleScript_EffectCurse                  @ EFFECT_CURSE
	asset_ptr BattleScript_EffectHit                    @ EFFECT_UNUSED_6E
	asset_ptr BattleScript_EffectProtect                @ EFFECT_PROTECT
	asset_ptr BattleScript_EffectSpikes                 @ EFFECT_SPIKES
	asset_ptr BattleScript_EffectForesight              @ EFFECT_FORESIGHT
	asset_ptr BattleScript_EffectPerishSong             @ EFFECT_PERISH_SONG
	asset_ptr BattleScript_EffectSandstorm              @ EFFECT_SANDSTORM
	asset_ptr BattleScript_EffectEndure                 @ EFFECT_ENDURE
	asset_ptr BattleScript_EffectRollout                @ EFFECT_ROLLOUT
	asset_ptr BattleScript_EffectSwagger                @ EFFECT_SWAGGER
	asset_ptr BattleScript_EffectFuryCutter             @ EFFECT_FURY_CUTTER
	asset_ptr BattleScript_EffectAttract                @ EFFECT_ATTRACT
	asset_ptr BattleScript_EffectReturn                 @ EFFECT_RETURN
	asset_ptr BattleScript_EffectPresent                @ EFFECT_PRESENT
	asset_ptr BattleScript_EffectFrustration            @ EFFECT_FRUSTRATION
	asset_ptr BattleScript_EffectSafeguard              @ EFFECT_SAFEGUARD
	asset_ptr BattleScript_EffectThawHit                @ EFFECT_THAW_HIT
	asset_ptr BattleScript_EffectMagnitude              @ EFFECT_MAGNITUDE
	asset_ptr BattleScript_EffectBatonPass              @ EFFECT_BATON_PASS
	asset_ptr BattleScript_EffectHit                    @ EFFECT_PURSUIT
	asset_ptr BattleScript_EffectRapidSpin              @ EFFECT_RAPID_SPIN
	asset_ptr BattleScript_EffectSonicboom              @ EFFECT_SONICBOOM
	asset_ptr BattleScript_EffectHit                    @ EFFECT_UNUSED_83
	asset_ptr BattleScript_EffectMorningSun             @ EFFECT_MORNING_SUN
	asset_ptr BattleScript_EffectSynthesis              @ EFFECT_SYNTHESIS
	asset_ptr BattleScript_EffectMoonlight              @ EFFECT_MOONLIGHT
	asset_ptr BattleScript_EffectHiddenPower            @ EFFECT_HIDDEN_POWER
	asset_ptr BattleScript_EffectRainDance              @ EFFECT_RAIN_DANCE
	asset_ptr BattleScript_EffectSunnyDay               @ EFFECT_SUNNY_DAY
	asset_ptr BattleScript_EffectDefenseUpHit           @ EFFECT_DEFENSE_UP_HIT
	asset_ptr BattleScript_EffectAttackUpHit            @ EFFECT_ATTACK_UP_HIT
	asset_ptr BattleScript_EffectAllStatsUpHit          @ EFFECT_ALL_STATS_UP_HIT
	asset_ptr BattleScript_EffectHit                    @ EFFECT_UNUSED_8D
	asset_ptr BattleScript_EffectBellyDrum              @ EFFECT_BELLY_DRUM
	asset_ptr BattleScript_EffectPsychUp                @ EFFECT_PSYCH_UP
	asset_ptr BattleScript_EffectMirrorCoat             @ EFFECT_MIRROR_COAT
	asset_ptr BattleScript_EffectSkullBash              @ EFFECT_SKULL_BASH
	asset_ptr BattleScript_EffectTwister                @ EFFECT_TWISTER
	asset_ptr BattleScript_EffectEarthquake             @ EFFECT_EARTHQUAKE
	asset_ptr BattleScript_EffectFutureSight            @ EFFECT_FUTURE_SIGHT
	asset_ptr BattleScript_EffectGust                   @ EFFECT_GUST
	asset_ptr BattleScript_EffectStomp                  @ EFFECT_FLINCH_MINIMIZE_HIT
	asset_ptr BattleScript_EffectSolarBeam              @ EFFECT_SOLAR_BEAM
	asset_ptr BattleScript_EffectThunder                @ EFFECT_THUNDER
	asset_ptr BattleScript_EffectTeleport               @ EFFECT_TELEPORT
	asset_ptr BattleScript_EffectBeatUp                 @ EFFECT_BEAT_UP
	asset_ptr BattleScript_EffectSemiInvulnerable       @ EFFECT_SEMI_INVULNERABLE
	asset_ptr BattleScript_EffectDefenseCurl            @ EFFECT_DEFENSE_CURL
	asset_ptr BattleScript_EffectSoftboiled             @ EFFECT_SOFTBOILED
	asset_ptr BattleScript_EffectFakeOut                @ EFFECT_FAKE_OUT
	asset_ptr BattleScript_EffectUproar                 @ EFFECT_UPROAR
	asset_ptr BattleScript_EffectStockpile              @ EFFECT_STOCKPILE
	asset_ptr BattleScript_EffectSpitUp                 @ EFFECT_SPIT_UP
	asset_ptr BattleScript_EffectSwallow                @ EFFECT_SWALLOW
	asset_ptr BattleScript_EffectHit                    @ EFFECT_UNUSED_A3
	asset_ptr BattleScript_EffectHail                   @ EFFECT_HAIL
	asset_ptr BattleScript_EffectTorment                @ EFFECT_TORMENT
	asset_ptr BattleScript_EffectFlatter                @ EFFECT_FLATTER
	asset_ptr BattleScript_EffectWillOWisp              @ EFFECT_WILL_O_WISP
	asset_ptr BattleScript_EffectMemento                @ EFFECT_MEMENTO
	asset_ptr BattleScript_EffectFacade                 @ EFFECT_FACADE
	asset_ptr BattleScript_EffectFocusPunch             @ EFFECT_FOCUS_PUNCH
	asset_ptr BattleScript_EffectSmellingsalt           @ EFFECT_SMELLINGSALT
	asset_ptr BattleScript_EffectFollowMe               @ EFFECT_FOLLOW_ME
	asset_ptr BattleScript_EffectNaturePower            @ EFFECT_NATURE_POWER
	asset_ptr BattleScript_EffectCharge                 @ EFFECT_CHARGE
	asset_ptr BattleScript_EffectTaunt                  @ EFFECT_TAUNT
	asset_ptr BattleScript_EffectHelpingHand            @ EFFECT_HELPING_HAND
	asset_ptr BattleScript_EffectTrick                  @ EFFECT_TRICK
	asset_ptr BattleScript_EffectRolePlay               @ EFFECT_ROLE_PLAY
	asset_ptr BattleScript_EffectWish                   @ EFFECT_WISH
	asset_ptr BattleScript_EffectAssist                 @ EFFECT_ASSIST
	asset_ptr BattleScript_EffectIngrain                @ EFFECT_INGRAIN
	asset_ptr BattleScript_EffectSuperpower             @ EFFECT_SUPERPOWER
	asset_ptr BattleScript_EffectMagicCoat              @ EFFECT_MAGIC_COAT
	asset_ptr BattleScript_EffectRecycle                @ EFFECT_RECYCLE
	asset_ptr BattleScript_EffectRevenge                @ EFFECT_REVENGE
	asset_ptr BattleScript_EffectBrickBreak             @ EFFECT_BRICK_BREAK
	asset_ptr BattleScript_EffectYawn                   @ EFFECT_YAWN
	asset_ptr BattleScript_EffectKnockOff               @ EFFECT_KNOCK_OFF
	asset_ptr BattleScript_EffectEndeavor               @ EFFECT_ENDEAVOR
	asset_ptr BattleScript_EffectEruption               @ EFFECT_ERUPTION
	asset_ptr BattleScript_EffectSkillSwap              @ EFFECT_SKILL_SWAP
	asset_ptr BattleScript_EffectImprison               @ EFFECT_IMPRISON
	asset_ptr BattleScript_EffectRefresh                @ EFFECT_REFRESH
	asset_ptr BattleScript_EffectGrudge                 @ EFFECT_GRUDGE
	asset_ptr BattleScript_EffectSnatch                 @ EFFECT_SNATCH
	asset_ptr BattleScript_EffectLowKick                @ EFFECT_LOW_KICK
	asset_ptr BattleScript_EffectSecretPower            @ EFFECT_SECRET_POWER
	asset_ptr BattleScript_EffectDoubleEdge             @ EFFECT_DOUBLE_EDGE
	asset_ptr BattleScript_EffectTeeterDance            @ EFFECT_TEETER_DANCE
	asset_ptr BattleScript_EffectBurnHit                @ EFFECT_BLAZE_KICK
	asset_ptr BattleScript_EffectMudSport               @ EFFECT_MUD_SPORT
	asset_ptr BattleScript_EffectPoisonFang             @ EFFECT_POISON_FANG
	asset_ptr BattleScript_EffectWeatherBall            @ EFFECT_WEATHER_BALL
	asset_ptr BattleScript_EffectOverheat               @ EFFECT_OVERHEAT
	asset_ptr BattleScript_EffectTickle                 @ EFFECT_TICKLE
	asset_ptr BattleScript_EffectCosmicPower            @ EFFECT_COSMIC_POWER
	asset_ptr BattleScript_EffectSkyUppercut            @ EFFECT_SKY_UPPERCUT
	asset_ptr BattleScript_EffectBulkUp                 @ EFFECT_BULK_UP
	asset_ptr BattleScript_EffectPoisonHit              @ EFFECT_POISON_TAIL
	asset_ptr BattleScript_EffectWaterSport             @ EFFECT_WATER_SPORT
	asset_ptr BattleScript_EffectCalmMind               @ EFFECT_CALM_MIND
	asset_ptr BattleScript_EffectDragonDance            @ EFFECT_DRAGON_DANCE
	asset_ptr BattleScript_EffectCamouflage             @ EFFECT_CAMOUFLAGE
